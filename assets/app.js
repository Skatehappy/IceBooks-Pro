...
// ../.npm-global/lib/node_modules/react/cjs/react.development.js
var require_react_development = __commonJS({
  "../.npm-global/lib/node_modules/react/cjs/react.development.js"(exports, module) {
    "use strict";
    (function() {
...
var USFSA_BASIC = ["Basic 1", "Basic 2", "Basic 3", "Basic 4", "Basic 5", "Basic 6"];
var USFSA_ASPIRE = ["Aspire 1", "Aspire 2", "Aspire 3", "Aspire 4"];
...
var USFSA_PATTERN_DANCE = [
  "Preliminary (Partnered - Lead)",
  "Preliminary (Partnered - Follow)",
  "Preliminary (Solo - Lead)",
  "Preliminary (Solo - Follow)",
  "Pre-Bronze (Partnered - Lead)",
  "Pre-Bronze (Partnered - Follow)",
  "Pre-Bronze (Solo - Lead)",
  "Pre-Bronze (Solo - Follow)",
  "Bronze (Partnered - Lead)",
  "Bronze (Partnered - Follow)",
  "Bronze (Solo - Lead)",
  "Bronze (Solo - Follow)",
  "Pre-Silver (Partnered - Lead)",
  "Pre-Silver (Partnered - Follow)",
  "Pre-Silver (Solo - Lead)",
  "Pre-Silver (Solo - Follow)",
  "Silver (Partnered - Lead)",
  "Silver (Partnered - Follow)",
  "Silver (Solo - Lead)",
  "Silver (Solo - Follow)",
  "Pre-Gold (Partnered - Lead)",
  "Pre-Gold (Partnered - Follow)",
  "Pre-Gold (Solo - Lead)",
  "Pre-Gold (Solo - Follow)",
  "Gold (Partnered - Lead)",
  "Gold (Partnered - Follow)",
  "Gold (Solo - Lead)",
  "Gold (Solo - Follow)",
  "International (Partnered - Lead)",
  "International (Partnered - Follow)",
  "International (Solo - Lead)",
  "International (Solo - Follow)"
];
var USFSA_FREE_DANCE = [
  "Bronze (Partnered)",
  "Bronze (Solo)",
  "Pre-Silver (Partnered)",
  "Pre-Silver (Solo)",
  "Silver (Partnered)",
  "Silver (Solo)",
  "Pre-Gold (Partnered)",
...
var USFSA_PAIRS = ["Bronze", "Pre-Silver", "Silver", "Pre-Gold", "Gold"];
var USFSA_ADULT_SKATING_SKILLS = [
  "Pre-Bronze (21+)",
  "Pre-Bronze (50+)",
  "Bronze (21+)",
  "Bronze (50+)",
...
var USFSA_ADULT_SOLO_FREE_DANCE = [
  "Juvenile (21+)",
  "Juvenile (50+)",
  "Intermediate (21+)",
  "Intermediate (50+)",
...
var USFSA_ADULT_PAIRS = ["Bronze", "Silver", "Gold"];
var USFSA_ADAPTIVE_SKATING_SKILLS = ["Pre-Bronze", "Bronze", "Silver", "Gold"];
var USFSA_ADAPTIVE_SINGLES = ["Pre-Bronze", "Bronze", "Silver", "Gold"];
var USFSA_SKATE_UNITED = [
  // Skating Skills
  "Pre-preliminary Skating Skills",
  "Preliminary Skating Skills",
  "Pre-Bronze Skating Skills",
  "Bronze Skating Skills",
  "Pre-Silver Skating Skills",
  "Silver Skating Skills",
  "Pre-Gold Skating Skills",
  "Gold Skating Skills",
  // Singles
  "Pre-preliminary Singles",
  "Preliminary Singles",
  "Pre-Bronze Singles",
  "Bronze Singles",
  "Pre-Silver Singles",
  ...
  "Silver Pattern Dance",
  "Gold Pattern Dance",
  "International Pattern Dance",
  // Free Dance
  "Bronze Free Dance",
  "Pre-Silver Free Dance",
  "Silver Free Dance",
  "Pre-Gold Free Dance",
  "Gold Free Dance",
  // Pairs
...
function App() {
  ...
  const renderModal = () => {
    ...
    )), /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: styles.label }, "Child Birthdate"), /* @__PURE__ */ import_react.default.createElement("input", { type: "date", style: styles.input, value: clientForm.child_birthdate, onChange: (e) => setClientForm({ ...clientForm, child_birthdate: e.target.value }) }))), /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: styles.label }, "Child Email (for self-login)"), /* @__PURE__ */ import_react.default.createElement("input", { type: "email", style: styles.input, value: clientForm.child_email, onChange: (e) => setClientForm({ ...clientForm, child_email: e.target.value }) })))), /* @__PURE__ */ import_react.default.createElement("div", { style: styles.modalFooter }, editingItem && isCoach && /* @__PURE__ */ import_react.default.createElement("button", { style: { ...styles.btn, ...styles.btnDanger, marginRight: "auto" }, onClick: () => deleteClient(editingItem.id) }, "Delete"), /* @__PURE__ */ import_react.default.createElement("button", { style: { ...styles.btn, ...styles.btnSecondary }, onClick: closeModal }, "Cancel"), /* @__PURE__ */ import_react.default.createElement("button", { style: { ...styles.btn, ...styles.btnPrimary }, onClick: saveClient }, "Save"))), showModal === "student" && /* @__PURE__ */ import_react.default.createElement(import_react.default.Fragment, null, /* @__PURE__ */ import_react.default.createElement("div", { style: styles.modalHeader }, /* @__PURE__ */ import_react.default.createElement("h3", { style: styles.modalTitle }, editingItem ? "Edit Student" : "New Student"), /* @__PURE__ */ import_react.default.createElement("button", { style: { ...styles.btn, ...styles.btnSecondary }, onClick: closeModal }, "\u2715")), /* @__PURE__ */ import_react.default.createElement("div", { style: styles.modalBody }, /* @__PURE__ */ import_react.default.createElement("div", { style: styles.row }, /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: styles.label }, "Parent/Client *"), /* @__PURE__ */ import_react.default.createElement("select", { style: styles.select, value: studentForm.client_id, onChange: (e) => setStudentForm({ ...studentForm, client_id: e.target.value }), required: true }, /* @__PURE__ */ import_react.default.createElement("option", { value: "" }, "Select parent..."), clients.map((c) => /* @__PURE__ */ import_react.default.createElement("option", { key: c.id, value: c.id }, c.name)))), /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: styles.label }, "Student Name ", isCoach ? "*" : ""), /* @__PURE__ */ import_react.default.createElement("input", { type: "text", style: styles.input, value: studentForm.name, onChange: (e) => setStudentForm({ ...studentForm, name: e.target.value }), placeholder: isCoach ? "" : "Leave blank to add yourself" }))), /* @__PURE__ */ import_react.default.createElement("div", { style: styles.row }, /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: styles.label }, "Email (Optional)"), /* @__PURE__ */ import_react.default.createElement("input", { type: "email", style: styles.input, value: studentForm.email, onChange: (e) => setStudentForm({ ...studentForm, email: e.target.value }), placeholder: isCoach ? "Optional" : "Optional (uses yours if blank)" })), /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: styles.label }, "Birthdate"), /* @__PURE__ */ import_react.default.createElement("input", { type: "date", style: styles.input, value: studentForm.birthdate, onChange: (e) => setStudentForm({ ...studentForm, birthdate: e.target.value }) }))), /* @__PURE__ */ import_react.default.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: 30, marginBottom: 20 } }, /* @__PURE__ */ import_react.default.createElement("h3", { style: { margin: 0, color: "#1e40af" } }, "ISI Skill Levels"), /* @__PURE__ */ import_react.default.createElement("div", { style: { width: 400 } }, /* @__PURE__ */ import_react.default.createElement("label", { style: { ...styles.label, color: "#1e40af", fontWeight: 600 } }, "ISI Membership Number"), /* @__PURE__ */ import_react.default.createElement("input", { type: "text", style: styles.input, value: studentForm.isi_number, onChange: (e) => setStudentForm({ ...studentForm, isi_number: e.target.value }), placeholder: "Enter ISI membership number" }))), /* @__PURE__ */ import_react.default.createElement("hr", { style: { marginBottom: 20, border: "none", borderTop: "3px solid #3b82f6" } }), /* @__PURE__ */ import_react.default.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 20, marginBottom: 20 } }, /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: { ...styles.label, color: "#1e40af" } }, "ISI Freestyle"), /* @__PURE__ */ import_react.default.createElement("select", { style: styles.select, value: studentForm.isi_freestyle, onChange: (e) => setStudentForm({ ...studentForm, isi_freestyle: e.target.value }) }, /* @__PURE__ */ import_react.default.createElement("option", { value: "" }, "Select..."), ISI_FREESTYLE_LEVELS.map((l) => /* @__PURE__ */ import_react.default.createElement("option", { key: l, value: l }, l)))), /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: { ...styles.label, color: "#1e40af" } }, "ISI Open Freestyle"), /* @__PURE__ */ import_react.default.createElement("select", { style: styles.select, value: studentForm.isi_open_freestyle, onChange: (e) => setStudentForm({ ...studentForm, isi_open_freestyle: e.target.value }) }, /* @__PURE__ */ import_react.default.createElement("option", { value: "" }, "Select..."), ISI_OPEN_FREESTYLE_LEVELS.map((l) => /* @__PURE__ */ import_react.default.createElement("option", { key: l, value: l }, l)))), /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: { ...styles.label, color: "#1e40af" } }, "ISI Figures"), /* @__PURE__ */ import_react.default.createElement("select", { style: styles.select, value: studentForm.isi_figures, onChange: (e) => setStudentForm({ ...studentForm, isi_figures: e.target.value }) }, /* @__PURE__ */ import_react.default.createElement("option", { value: "" }, "Select..."), ISI_FIGURES_LEVELS.map((l) => /* @__PURE__ */ import_react.default.createElement("option", { key: l, value: l }, l)))), /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: { ...styles.label, color: "#1e40af" } }, "ISI Couples"), /* @__PURE__ */ import_react.default.createElement("select", { style: styles.select, value: studentForm.isi_couples, onChange: (e) => setStudentForm({ ...studentForm, isi_couples: e.target.value }) }, /* @__PURE__ */ import_react.default.createElement("option", { value: "" }, "Select..."), ISI_COUPLES_LEVELS.map((l) => /* @__PURE__ */ import_react.default.createElement("option", { key: l, value: l }, l))))), /* @__PURE__ */ import_react.default.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 20, marginBottom: 20 } }, /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: { ...styles.label, color: "#1e40af" } }, "ISI Pairs"), /* @__PURE__ */ import_react.default.createElement("select", { style: styles.select, value: studentForm.isi_pairs, onChange: (e) => setStudentForm({ ...studentForm, isi_pairs: e.target.value }) }, /* @__PURE__ */ import_react.default.createElement("option", { value: "" }, "Select..."), ISI_PAIRS_LEVELS.map((l) => /* @__PURE__ */ import_react.default.createElement("option", { key: l, value: l }, l)))), /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: { ...styles.label, color: "#1e40af" } }, "ISI Ice Dance"), /* @__PURE__ */ import_react.default.createElement("select", { style: styles.select, value: studentForm.isi_icedance, onChange: (e) => setStudentForm({ ...studentForm, isi_icedance: e.target.value }) }, /* @__PURE__ */ import_react.default.createElement("option", { value: "" }, "Select..."), ISI_ICEDANCE_LEVELS.map((l) => /* @__PURE__ */ import_react.default.createElement("option", { key: l, value: l }, l)))), /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: { ...styles.label, color: "#1e40af" } }, "ISI International Dance"), /* @__PURE__ */ import_react.default.createElement("select", { style: styles.select, value: studentForm.isi_international_dance, onChange: (e) => setStudentForm({ ...studentForm, isi_international_dance: e.target.value }) }, /* @__PURE__ */ import_react.default.createElement("option", { value: "" }, "Select..."), ISI_INTERNATIONAL_DANCE_ALL.map((l) => /* @__PURE__ */ import_react.default.createElement("option", { key: l, value: l }, l)))), /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: { ...styles.label, color: "#1e40af" } }, "ISI Free Dance Partnered"), /* @__PURE__ */ import_react.default.createElement("select", { style: styles.select, value: studentForm.isi_freedance_partnered, onChange: (e) => setStudentForm({ ...studentForm, isi_freedance_partnered: e.target.value }) }, /* @__PURE__ */ import_react.default.createElement("option", { value: "" }, "Select..."), ISI_FREEDANCE_PARTNERED_LEVELS.map((l) => /* @__PURE__ */ import_react.default.createElement("option", { key: l, value: l }, l))))), /* @__PURE__ */ import_react.default.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 20, marginBottom: 20 } }, /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: { ...styles.label, color: "#1e40af" } }, "Open Solo Free Dance"), /* @__PURE__ */ import_react.default.createElement("select", { style: styles.select, value: studentForm.isi_solo_freedance, onChange: (e) => setStudentForm({ ...studentForm, isi_solo_freedance: e.target.value }) }, /* @__PURE__ */ import_react.default.createElement("option", { value: "" }, "Select..."), ISI_SOLO_FREEDANCE_LEVELS.map((l) => /* @__PURE__ */ import_react.default.createElement("option", { key: l, value: l }, l)))), /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: { ...styles.label, color: "#1e40af" } }, "ISI Synchro"), /* @__PURE__ */ import_react.default.createElement("select", { style: styles.select, value: studentForm.isi_synchro, onChange: (e) => setStudentForm({ ...studentForm, isi_synchro: e.target.value }) }, /* @__PURE__ */ import_react.default.createElement("option", { value: "" }, "Select..."), ISI_SYNCHRO_LEVELS.map((l) => /* @__PURE__ */ import_react.default.createElement("option", { key: l, value: l }, l)))), /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: { ...styles.label, color: "#1e40af" } }, "ISI Special Skater"), /* @__PURE__ */ import_react.default.createElement("select", { style: styles.select, value: studentForm.isi_special_skater, onChange: (e) => setStudentForm({ ...studentForm, isi_special_skater: e.target.value }) }, /* @__PURE__ */ import_react.default.createElement("option", { value: "" }, "Select..."), ISI_SPECIAL_SKATER_LEVELS.map((l) => /* @__PURE__ */ import_react.default.createElement("option", { key: l, value: l }, l))))), /* @__PURE__ */ import_react.default.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: 30, marginBottom: 20 } }, /* @__PURE__ */ import_react.default.createElement("h3", { style: { margin: 0, color: "#047857" } }, "USFSA Standard Track"), /* @__PURE__ */ import_react.default.createElement("div", { style: { width: 400 } }, /* @__PURE__ */ import_react.default.createElement("label", { style: { ...styles.label, color: "#047857", fontWeight: 600 } }, "USFSA Membership Number"), /* @__PURE__ */ import_react.default.createElement("input", { type: "text", style: styles.input, value: studentForm.usfsa_number, onChange: (e) => setStudentForm({ ...studentForm, usfsa_number: e.target.value }), placeholder: "Enter USFSA membership number" }))), /* @__PURE__ */ import_react.default.createElement("hr", { style: { marginBottom: 20, border: "none", borderTop: "3px solid #10b981" } }), /* @__PURE__ */ import_react.default.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 20, marginBottom: 20 } }, /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: { ...styles.label, color: "#047857" } }, "Basic 1-6"), /* @__PURE__ */ import_react.default.createElement("select", { style: styles.select, value: studentForm.usfsa_basic, onChange: (e) => setStudentForm({ ...studentForm, usfsa_basic: e.target.value }) }, /* @__PURE__ */ import_react.default.createElement("option", { value: "" }, "Select..."), USFSA_BASIC.map((l) => /* @__PURE__ */ import_react.default.createElement("option", { key: l, value: l }, l)))), /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: { ...styles.label, color: "#047857" } }, "Aspire 1-4"), /* @__PURE__ */ import_react.default.createElement("select", { style: styles.select, value: studentForm.usfsa_aspire, onChange: (e) => setStudentForm({ ...studentForm, usfsa_aspire: e.target.value }) }, /* @__PURE__ */ import_react.default.createElement("option", { value: "" }, "Select..."), USFSA_ASPIRE.map((l) => /* @__PURE__ */ import_react.default.createElement("option", { key: l, value: l }, l)))), /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: { ...styles.label, color: "#047857" } }, "Skating Skills"), /* @__PURE__ */ import_react.default.createElement("select", { style: styles.select, value: studentForm.usfsa_skating_skills, onChange: (e) => setStudentForm({ ...studentForm, usfsa_skating_skills: e.target.value }) }, /* @__PURE__ */ import_react.default.createElement("option", { value: "" }, "Select..."), USFSA_SKATING_SKILLS.map((l) => /* @__PURE__ */ import_react.default.createElement("option", { key: l, value: l }, l))))), /* @__PURE__ */ import_react.default.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 20, marginBottom: 20 } }, /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: { ...styles.label, color: "#047857" } }, "Singles"), /* @__PURE__ */ import_react.default.createElement("select", { style: styles.select, value: studentForm.usfsa_singles, onChange: (e) => setStudentForm({ ...studentForm, usfsa_singles: e.target.value }) }, /* @__PURE__ */ import_react.default.createElement("option", { value: "" }, "Select..."), USFSA_SINGLES.map((l) => /* @__PURE__ */ import_react.default.createElement("option", { key: l, value: l }, l)))), /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: { ...styles.label, color: "#047857" } }, "Pattern Dance"), /* @__PURE__ */ import_react.default.createElement("select", { style: styles.select, value: studentForm.usfsa_pattern_dance, onChange: (e) => setStudentForm({ ...studentForm, usfsa_pattern_dance: e.target.value }) }, /* @__PURE__ */ import_react.default.createElement("option", { value: "" }, "Select..."), USFSA_PATTERN_DANCE.map((l) => /* @__PURE__ */ import_react.default.createElement("option", { key: l, value: l }, l)))), /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: { ...styles.label, color: "#047857" } }, "Free Dance"), /* @__PURE__ */ import_react.default.createElement("select", { style: styles.select, value: studentForm.usfsa_free_dance, onChange: (e) => setStudentForm({ ...studentForm, usfsa_free_dance: e.target.value }) }, /* @__PURE__ */ import_react.default.createElement("option", { value: "" }, "Select..."), USFSA_FREE_DANCE.map((l) => /* @__PURE__ */ import_react.default.createElement("option", { key: l, value: l }, l))))), /* @__PURE__ */ import_react.default.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 20, marginBottom: 20 } }, /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: { ...styles.label, color: "#047857" } }, "Pairs"), /* @__PURE__ */ import_react.default.createElement("select", { style: styles.select, value: studentForm.usfsa_pairs, onChange: (e) => setStudentForm({ ...studentForm, usfsa_pairs: e.target.value }) }, /* @__PURE__ */ import_react.default.createElement("option", { value: "" }, "Select..."), USFSA_PAIRS.map((l) => /* @__PURE__ */ import_react.default.createElement("option", { key: l, value: l }, l))))), /* @__PURE__ */ import_react.default.createElement("h3", { style: { marginTop: 30, marginBottom: 20, color: "#047857" } }, "USFSA Adult Track"), /* @__PURE__ */ import_react.default.createElement("hr", { style: { marginBottom: 20, border: "none", borderTop: "3px solid #10b981" } }), /* @__PURE__ */ import_react.default.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 20, marginBottom: 20 } }, /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: { ...styles.label, color: "#047857" } }, "Adult Skating Skills (21+ or 50+)"), /* @__PURE__ */ import_react.default.createElement("select", { style: styles.select, value: studentForm.usfsa_adult_skating_skills, onChange: (e) => setStudentForm({ ...studentForm, usfsa_adult_skating_skills: e.target.value }) }, /* @__PURE__ */ import_react.default.createElement("option", { value: "" }, "Select..."), USFSA_ADULT_SKATING_SKILLS.map((l) => /* @__PURE__ */ import_react.default.createElement("option", { key: l, value: l }, l)))), /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: { ...styles.label, color: "#047857" } }, "Adult Singles (21+ or 50+)"), /* @__PURE__ */ import_react.default.createElement("select", { style: styles.select, value: studentForm.usfsa_adult_singles, onChange: (e) => setStudentForm({ ...studentForm, usfsa_adult_singles: e.target.value }) }, /* @__PURE__ */ import_react.default.createElement("option", { value: "" }, "Select..."), USFSA_ADULT_SINGLES.map((l) => /* @__PURE__ */ import_react.default.createElement("option", { key: l, value: l }, l)))), /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: { ...styles.label, color: "#047857" } }, "Adult Pattern Dance (21+ or 50+)"), /* @__PURE__ */ import_react.default.createElement("select", { style: styles.select, value: studentForm.usfsa_adult_pattern_dance, onChange: (e) => setStudentForm({ ...studentForm, usfsa_adult_pattern_dance: e.target.value }) }, /* @__PURE__ */ import_react.default.createElement("option", { value: "" }, "Select..."), USFSA_ADULT_PATTERN_DANCE.map((l) => /* @__PURE__ */ import_react.default.createElement("option", { key: l, value: l }, l))))), /* @__PURE__ */ import_react.default.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 20, marginBottom: 20 } }, /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: { ...styles.label, color: "#047857" } }, "Adult Free Dance (21+ or 50+)"), /* @__PURE__ */ import_react.default.createElement("select", { style: styles.select, value: studentForm.usfsa_adult_free_dance, onChange: (e) => setStudentForm({ ...studentForm, usfsa_adult_free_dance: e.target.value }) }, /* @__PURE__ */ import_react.default.createElement("option", { value: "" }, "Select..."), USFSA_ADULT_FREE_DANCE.map((l) => /* @__PURE__ */ import_react.default.createElement("option", { key: l, value: l }, l)))), /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: { ...styles.label, color: "#047857" } }, "Adult Solo Free Dance (21+ or 50+)"), /* @__PURE__ */ import_react.default.createElement("select", { style: styles.select, value: studentForm.usfsa_adult_solo_free_dance, onChange: (e) => setStudentForm({ ...studentForm, usfsa_adult_solo_free_dance: e.target.value }) }, /* @__PURE__ */ import_react.default.createElement("option", { value: "" }, "Select..."), USFSA_ADULT_SOLO_FREE_DANCE.map((l) => /* @__PURE__ */ import_react.default.createElement("option", { key: l, value: l }, l)))), /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: { ...styles.label, color: "#047857" } }, "Adult Pairs"), /* @__PURE__ */ import_react.default.createElement("select", { style: styles.select, value: studentForm.usfsa_adult_pairs, onChange: (e) => setStudentForm({ ...studentForm, usfsa_adult_pairs: e.target.value }) }, /* @__PURE__ */ import_react.default.createElement("option", { value: "" }, "Select..."), USFSA_ADULT_PAIRS.map((l) => /* @__PURE__ */ import_react.default.createElement("option", { key: l, value: l }, l))))), /* @__PURE__ */ import_react.default.createElement("h3", { style: { marginTop: 30, marginBottom: 20, color: "#047857" } }, "USFSA Adaptive Track"), /* @__PURE__ */ import_react.default.createElement("hr", { style: { marginBottom: 20, border: "none", borderTop: "3px solid #10b981" } }), /* @__PURE__ */ import_react.default.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 20, marginBottom: 20 } }, /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: { ...styles.label, color: "#047857" } }, "Adaptive Skating Skills"), /* @__PURE__ */ import_react.default.createElement("select", { style: styles.select, value: studentForm.usfsa_adaptive_skating_skills, onChange: (e) => setStudentForm({ ...studentForm, usfsa_adaptive_skating_skills: e.target.value }) }, /* @__PURE__ */ import_react.default.createElement("option", { value: "" }, "Select..."), USFSA_ADAPTIVE_SKATING_SKILLS.map((l) => /* @__PURE__ */ import_react.default.createElement("option", { key: l, value: l }, l)))), /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: { ...styles.label, color: "#047857" } }, "Adaptive Singles"), /* @__PURE__ */ import_react.default.createElement("select", { style: styles.select, value: studentForm.usfsa_adaptive_singles, onChange: (e) => setStudentForm({ ...studentForm, usfsa_adaptive_singles: e.target.value }) }, /* @__PURE__ */ import_react.default.createElement("option", { value: "" }, "Select..."), USFSA_ADAPTIVE_SINGLES.map((l) => /* @__PURE__ */ import_react.default.createElement("option", { key: l, value: l }, l)))), /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: { ...styles.label, color: "#047857" } }, "Skate United"), /* @__PURE__ */ import_react.default.createElement("select", { style: styles.select, value: studentForm.usfsa_skate_united, onChange: (e) => setStudentForm({ ...studentForm, usfsa_skate_united: e.target.value }) }, /* @__PURE__ */ import_react.default.createElement("option", { value: "" }, "Select..."), USFSA_SKATE_UNITED.map((l) => /* @__PURE__ */ import_react.default.createElement("option", { key: l, value: l }, l))))), /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: styles.label }, "Notes"), /* @__PURE__ */ import_react.default.createElement("textarea", { rows: "4", style: styles.textarea, value: studentForm.notes, onChange: (e) => setStudentForm({ ...studentForm, notes: e.target.value }) }))), /* @__PURE__ */ import_react.default.createElement("div", { style: styles.modalFooter }, /* @__PURE__ */ import_react.default.createElement("button", { style: { ...styles.btn, ...styles.btnSecondary }, onClick: closeModal }, "Cancel"), /* @__PURE__ */ import_react.default.createElement("button", { style: { ...styles.btn, ...styles.btnPrimary }, onClick: saveStudent }, "Save Student"))), showModal === "venue" && /* @__PURE__ */ import_react.default.createElement(import_react.default.Fragment, null, /* @__PURE__ */ import_react.default.createElement("div", { style: styles.modalHeader }, /* @__PURE__ */ import_react.default.createElement("h3", { style: styles.modalTitle }, editingItem ? "Edit Venue" : "New Venue"), /* @__PURE__ */ import_react.default.createElement("button", { style: { ...styles.btn, ...styles.btnSecondary }, onClick: closeModal }, "\u2715")), /* @__PURE__ */ import_react.default.createElement("div", { style: styles.modalBody }, /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: styles.label }, "Venue Name *"), /* @__PURE__ */ import_react.default.createElement("input", { type: "text", style: styles.input, value: venueForm.name, onChange: (e) => setVenueForm({ ...venueForm, name: e.target.value }), placeholder: "e.g., Winterland Ice Arena", required: true })), /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: styles.label }, "Address"), /* @__PURE__ */ import_react.default.createElement("input", { type: "text", style: styles.input, value: venueForm.address, onChange: (e) => setVenueForm({ ...venueForm, address: e.target.value }), placeholder: "123 Ice Way, Skating City, ST 12345" })), /* @__PURE__ */ import_react.default.createElement("div", { style: styles.formGroup }, /* @__PURE__ */ import_react.default.createElement("label", { style: styles.label }, "Color (for calendar dot)"), /* @__PURE__ */ import_react.default.createElement("div", { style: { display: "flex", gap: 8, alignItems: "center" } }, /* @__PURE__ */ import_react.default.createElement(
      "input",
      {
        type: "color",
